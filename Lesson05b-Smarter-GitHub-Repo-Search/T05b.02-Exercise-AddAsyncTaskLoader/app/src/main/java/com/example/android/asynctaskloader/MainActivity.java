...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private int GITHUB_SEARCH_LOADER;
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery == null || githubQuery.equals("")){
            mUrlDisplayTextView.setText("No text entered, nothing to search for.");
            return;
        }
        ...
        android.support.v4.content.Loader<Object> gitHubSearchLoader = lm.getLoader(GITHUB_SEARCH_LOADER);
