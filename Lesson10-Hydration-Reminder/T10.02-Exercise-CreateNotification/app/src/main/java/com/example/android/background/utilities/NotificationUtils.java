...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 3333;

    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "reminder_notification_channnel";

    private static final int WATER_REMINDER_NOTIFICATION_ID = 3334;
    ...
    private static Bitmap largeIcon (Context context) {
        ...
        Bitmap formattedIcon = BitmapFactory.decodeResource(resource, R.drawable.ic_local_drink_black_24px);
