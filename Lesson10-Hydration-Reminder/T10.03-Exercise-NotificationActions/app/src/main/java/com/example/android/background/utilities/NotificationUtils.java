...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 9888;

    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 1444;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreIntentPending = PendingIntent.getService(
                context,
        ...
        NotificationCompat.Action ignoreNotification = new NotificationCompat.Action(
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        Intent drinkWater = new Intent(context, WaterReminderIntentService.class);

        //      TODO (13) Set the action of the intent to designate you want to increment the water count
        drinkWater.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        //      TODO (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent drinkIntentPending = PendingIntent.getService(
                context,
        ...
        NotificationCompat.Action drinkWaterNow = new NotificationCompat.Action(
                R.drawable.ic_drink_notification,
                "DONE!",
                drinkIntentPending);

        //      TODO (16) Return the action
        return drinkWaterNow;
    }
