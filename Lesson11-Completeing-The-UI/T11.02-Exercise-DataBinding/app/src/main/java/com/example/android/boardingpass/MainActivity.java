...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardingPassInfo fakeBPinfo = FakeDataUtils.generateFakeBoardingPassInfo();

        // TODO (9) Call displayBoardingPassInfo and pass the fake BoardingInfo instance
        displayBoardingPassInfo(fakeBPinfo);
    }
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long minsLessHoursUntilBoarding = totalMinsUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);

        String hoursAndMinsUntilBoarding = getString(R.string.countDownFormat, hoursUntilBoarding, minsLessHoursUntilBoarding);
